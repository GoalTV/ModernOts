local keywordHandler = KeywordHandler:new()
		...
		local travelNode2 = keywordHandler:addKeyword({'yalahar'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Do I look like a ferryman?! Well... if I think about it, I could use some sailing practice. I can bring you to Yalahar for 100 gold. Agreed?'})
        	travelNode2:addChildKeyword({'yes'}, StdModule.travel, {npcHandler = npcHandler, premium = false, level = 0, cost = 50, destination = {x=446, y=693, z=6}, msg = 'Set the sails!' })
