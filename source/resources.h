...
#define CLIENT_VERSION_STRING "0.3"

#define STATUS_SERVER_NAME "ModernOts 0.3 Engine Edition"
#define STATUS_SERVER_VERSION "For 8.6"
#define STATUS_SERVER_CODENAME "ModernOts 0.3 Engine Edition"
